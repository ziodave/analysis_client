...
class AnalysesResponseItem(BaseModel):
    ...
    confidence: Optional[Union[Annotated[float, Field(le=1.0, strict=True, ge=0.0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(default=None, description="The confidence score this is the right entity.")
