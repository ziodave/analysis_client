...
class TestResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Response:
        ...
        if include_optional:
            return Response(
                entities = {
                    'key' : analysis_client.models.entity.Entity(
                        entity_id = '', 
                        confidence = 1.337, 
                        main_type = '', 
                        types = [
                ...
                annotations = {
                    'key' : analysis_client.models.annotation.Annotation(
                        annotation_id = '', 
                        start = 56, 
                        end = 56, 
                        text = '', 
                        entity_matches = [
                            analysis_client.models.entity_match.EntityMatch(
                                confidence = 1.337, 
                                entity_id = '', )
                            ], )
                    },
                images = [
                    analysis_client.models.image.Image(
                        label = '', 
                        url = '', )
                    ],
                languages = [
                ...
                topics = [
                    analysis_client.models.topic.Topic(
                        label = '', 
                        description = '', 
                        uri = '', 
                        confidence = 1.337, 
